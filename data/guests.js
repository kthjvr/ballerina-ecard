...
export const GUEST_LISTS = [
    {
        ...
        guests: ["Tita Cathy", "Ninang Rona", "Ninang Tuan", "Ninong Gerald", "Ninang Tintin", "Ninang Gerlie", "Ninang Gelai"]
    },
    {
        title: "7 Treasures",
        ...
        guests: ["Ninong Rico", "Ninang Nicol", "Ninong Ryan", "Ninong Renzon", "Ninang Kathy Receno", "Ninang Mhalen", "Ninang  Corazon"]
    },
    {
        title: "7 Wishes- candles",
        ...
        guests: ["Mama Karen", "Inay Nelia", "Lola Mercy", "Tita Miriam", "Lola Angie", "Lola Letty", "Lola Tasweng"]
    },
    {
        title: "7 Clothes/Dresses",
        ...
        guests: ["Damaris Alexa", "Cassie Mutia", "Bea Torno", "Kryszzle Del Rio", "Elle Dimaculangan", "Hiraya Mithi", "Ate Emmanuel Grace"]
    },
    {
        title: "7 Dance",
        icon: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="icon icon-tabler icons-tabler-filled icon-tabler-gift">
        ...
        guests: ["Lolo Rudy", "Tatay Caloy", "Lolo Gary", "Tito Noel", "Tito Karlo", "Kuya Clark", "Daddy (last dance)"]
    },
    {
        title: "7 Toys",
        icon: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="icon icon-tabler icons-tabler-filled icon-tabler-gift">
        ...
        guests: ["Enzo Maguiat", "Dreike Ramos", "Brent Silva", "Gabriel Kalalo", "Nate Latayan", "Kuya Nero", "Kuya Brent"]
    },
    {
        title: "7 Footwears",
        icon: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="icon icon-tabler icons-tabler-filled icon-tabler-gift">
        ...
        guests: ["Ate Kashmir", "Ate Kyla", "Ate Joan", "Ate MZ", "Tita Jelli", "Tita Che-che", "Tita Jona"]
    }
